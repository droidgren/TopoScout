const LANG_SV = {
    ...
    tutorial_radius_title: "Sökradie",
    tutorial_radius_text: "Ange hur stort sökområdet ska vara (i km). Den blå cirkeln på kartan visar detta område.",
    tutorial_points_title: "Antal punkter",
    tutorial_points_text: "Välj hur många toppar som ska hittas inom sökradien.",
    tutorial_scan_title: "Hitta högsta punkter",
    tutorial_scan_text: "Klicka på den här knappen för att skanna området och hitta de högsta höjdpunkterna inom din radie.",
