const LANG_EN = {
    ...
    route_legend_show_all: "Show all",
    ...
    tutorial_layers_tools_text: "• Map Layers: Choose your preferred map style. (Note: Some layers require a free API key).\n• Route overlay: Turn on \"Show route overlay\" to draw marked routes over the map, then enable \"Show route names\" for a legend of the routes currently in view.\n• Filter a trail: click a route in the legend to show only that trail; click \"Show all\" to bring them back.",
    tutorial_tools_title: "Map Tools",
    tutorial_tools_text: "• Overzoom: Zoom in beyond the standard limit. This enlarges the map but does not reveal extra detail.\n• Tilt: Enable Tilt to pitch and rotate the map\n• Enable 3D to view terrain with adjustable exaggeration.\n• Use the search box to find a place by name or coordinates, or click the GPS button to jump to your current location.",
