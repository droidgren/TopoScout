const LANG_EN = {
    ...
    tutorial_radius_title: "Search Radius",
    tutorial_radius_text: "Set how large the search area should be (in km). The blue circle on the map shows this area.",
    tutorial_points_title: "Number of Points",
    tutorial_points_text: "Choose how many highest peaks to find within the search radius.",
    tutorial_scan_title: "Find Highest Points",
    tutorial_scan_text: "Click this button to scan the area and find the highest elevation points within your radius.",
